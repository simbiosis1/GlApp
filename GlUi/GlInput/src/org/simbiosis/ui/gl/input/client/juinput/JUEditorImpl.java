...
public class JUEditorImpl extends FormWidget implements IJUForm,
		Editor<GLTransDv> {
	...
	interface MyUiBinder extends UiBinder<Widget, JUEditorImpl> {
	}

	interface Driver extends SimpleBeanEditorDriver<GLTransDv, JUEditorImpl> {
	}
